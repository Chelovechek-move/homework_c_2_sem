    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            if (event.type == sf::Event::MouseButtonReleased)
            {
                ...
                {
                    bool some_checkbox_is_activated = false;

                    for (std::vector<Checkbox>::iterator it = checkboxes.begin(); it != checkboxes.end(); it++)
                    {
                        if ((*it).isActivated() == true)
                        {
                            some_checkbox_is_activated = true;
                            break;
                        }                            
                    }
                    if(some_checkbox_is_activated == true)
                    {
                        for (std::vector<Checkbox>::iterator it = checkboxes.begin(); it != checkboxes.end(); it++)
                        {
                            if ((*it).isActivated() == true)
