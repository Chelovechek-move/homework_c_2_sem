    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            if (event.type == sf::Event::MouseButtonPressed)
            {
                ...
                if (context_menu_press_result == 5)
                {
                ...
                if (context_menu_press_result == 6)
                {
                    std::cout << "Change radius" << std::endl;

                    circle.setRadius(rand() % 60);
                    circle.setOrigin({circle.getRadius() / 2, circle.getRadius() / 2});
                    circle.setPosition({600, 180});
                }
                ...
                if (event.mouseButton.button == sf::Mouse::Right)
                {
                    if (distance(mouse_position, circle.getPosition() + circle.getOrigin()) < circle.getRadius() && clicking_on_the_circle == false)
                    {
                    ...
                    {
                        if(distance(mouse_position, circle.getPosition() + circle.getOrigin()) > circle.getRadius() && clicking_on_the_circle == true)
                        {
            ...
            if (event.type == sf::Event::MouseButtonReleased)
            {
                ...
                // if(clicking_on_the_circle == true)
                // {
                //     clicking_on_the_circle = false;
                //     context_menu.deleteButton("Change color");
                //     context_menu.deleteButton("Change radius");
